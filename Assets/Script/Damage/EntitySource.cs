...
namespace KarpysDev.Script.Damage
{
    ...
    public class EntitySource:ISource
    {
        ...
        public EntitySource(BaseEntity entity, EntityAnimator animator,Transform spawnRoot,EntityController entityController,IRoot root)
        {
            m_BaseEntity = entity;
            m_Animator = animator;
            m_Root = root;
